...
<header class="relative bg-blue-400">
    <div class="flex items-center justify-between h-24 px-8 mx-auto max-w-7xl">
        ...
        <nav class="items-center justify-center hidden space-x-8 text-gray-200 md:flex">
            <a href="/insurance/home" x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false" class="relative inline-block text-base font-bold text-gray-700 uppercase transition duration-150 ease hover:text-gray-900">
